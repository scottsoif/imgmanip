...
main: main.o
	$(CC) main.o testModule.o -o main $(LDFLAGS) $(LDLIBS)

main.o: main.cpp testModule.o imgmanip/imgio/pch.h.gch imgmanip/imgio/imgio.h imgmanip/homography.h imgmanip/mosaic.h
